...
# Common error: "[Sun Jun 03 13:18:14.345457 2018] [backend:error] [pid 22240] [client 132.66.1.18:61229] End of script output before headers: modelteller_cgi.py"
...
with open('/bioseq/data/results/modelteller/test_run/sandbox.txt', 'w') as f:
